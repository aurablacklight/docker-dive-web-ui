# =============================================================================
# NGINX CONFIGURATION FOR DIVE INSPECTOR
# Secure reverse proxy with Cloudflare optimization
# =============================================================================
...
server {
    ...
    # SSL Configuration (Cloudflare handles termination, but keeping for flexibility)
    ...
    # Logging
    access_log /var/log/nginx/dive-inspector-access.log;
    error_log /var/log/nginx/dive-inspector-error.log;
    ...
    # Gzip compression (Cloudflare handles this, but keeping for direct access)
    gzip on;
    gzip_vary on;
    ...
    location /api/ {
        ...
        # Timeouts for analysis operations
